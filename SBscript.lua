...
AntiLava.CanCollide = false
                ...
                local Window = OrionLib:MakeWindow({Name = "Slap Battles Hub | Slap Royale", HidePremium = true, IntroEnabled = false, SaveConfig = false, ConfigFolder = "OrionTest"})
...
Tab4:AddLabel("Emotes Available: floss, groove, headless, helicopter, kick, l, laugh, parker, spasm, thriller")
Tab4:AddLabel("Use \"/e [EMOTENAME]\" to use the emote")
...
elseif game.PlaceId == 11520107397 then
                ...
                local Window = OrionLib:MakeWindow({Name = "Slap Battles Hub | Killstreak Only", HidePremium = true, IntroEnabled = false, SaveConfig = false, ConfigFolder = "OrionTest"})
...
Tab4:AddLabel("Good for leaking Gloves")
